...
import com.techwolf.poseidon.demo.flink.common.util.DateTimeDsBucketer;
 ...
 * @author zhoupeijie
 */
public class HdfsHiveSink implements BasicSink<String>{
    ...
    public SinkFunction<String> getSink(ParameterTool parameterTool, String sink) {
        ...
        hdfsSink.setBucketer(new DateTimeDsBucketer<String>(pathFormat,ZoneId.of(zone)));
